...
print("***Cake Recipe***")
print(f"""First preheat the oven to {first_number} degrees. Then beat {second_number} {animal} egg(s) with a cup of {liquid}.  Next add {third_number} teaspoon(s) of baking soda and mix with eggs and {liquid} until it reaches a {first_adj} texture.  4Don't forget the {sweet_food}! Pour into a 9 by 9 pan and bake for {fourth_number} minute(s) or until the cake is {second_adj}.""")